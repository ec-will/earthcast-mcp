...
export class ApiError extends Error {
  ...
  public readonly service: 'NOAA' | 'OpenMeteo' | 'NCEI' | 'RainViewer' | 'Nominatim' | 'Earthcast';
  ...
  constructor(
    message: string,
    statusCode: number,
    service: 'NOAA' | 'OpenMeteo' | 'NCEI' | 'RainViewer' | 'Nominatim' | 'Earthcast',
    userMessage: string,
    helpLinks: string[] = [],
...
export class RateLimitError extends ApiError {
  ...
  constructor(service: 'NOAA' | 'OpenMeteo' | 'NCEI' | 'RainViewer' | 'Nominatim' | 'Earthcast', messageOrRetryAfter?: string | number, retryAfter?: number) {
...
export class ServiceUnavailableError extends ApiError {
  constructor(service: 'NOAA' | 'OpenMeteo' | 'NCEI' | 'RainViewer' | 'Nominatim' | 'Earthcast', messageOrError?: string | Error, originalError?: Error) {
...
export class DataNotFoundError extends ApiError {
  constructor(service: 'NOAA' | 'OpenMeteo' | 'NCEI' | 'RainViewer' | 'Nominatim' | 'Earthcast', message: string) {
    super(
      message,
      404,
      service,
